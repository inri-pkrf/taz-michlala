...
const warsData = {
  ...
  yomKippur: {
    ...
    longDescription: ` במסגרת מערכת "שאגת הארי", הובילה המכללה את מוקד הלמידה המבצעית שהפיק מאות לקחים ותחקורים מהשטח, הפעילה את המרס"ל לתיאום ומתן מענה סיוע אזרחי בקו העימות, והכשירה מאות מתנדבי סע"ר לצד עשרות מפגשים מקוונים ומאגרי ידע דיגיטליים לניהול מצבי חירום. `,
    bgImage: `${process.env.PUBLIC_URL}/assets/AtWar/all/buildings.webp`, 
    popups: [
      { 
        id: 1, 
        title: `מרכז למידה מבצעית`, 
        content: `המרכז ירד לשטח ללמידה מהירה מול המפקדות והרשויות, הפיק 423 לקחים מ-37 אתרי חילוץ ו-32 רשויות, והפיץ 18 מנשרי למידה מבצעית לצד הפעלת צ'אט תובנות למפקדים.`, 
        borderColor: "#8D242D",
        x: "70%", y: "5%", width: "20%", height: "35%",
        topNum: "7vh", leftNum: "69vw" 
      },
      { 
        id: 2, 
        title: `הפעלת המרס"ל - גזרת הצפון`, 
        content: `מרכז הסיוע כיוון מענה לגזרת הצפון, תיאום בין 10 ארגונים ופורומים רב-מגזריים, וטיפל ב-98 בקשות מובילות לציוד, מזון לחג וערכות הפגה.`, 
        borderColor: "#B74548",
        x: "48%", y: "20%", width: "18%", height: "20%",
        topNum: "14vh", leftNum: "35vw" 
      },
      { 
        id: 3, 
        title: `'זמן יקר' והדרכות במפקדות`, 
        content: `חיזוק המוכנות המבצעית באמצעות 14 מפגשים מקוונים לכ-1,350 מנהלי מכלולים, לצד עשרות הדרכות שו"ב, העמקות מקצועיות ואימונים יחידתיים לפתיחת מס"ר.`, 
        borderColor: "#924768",
        x: "25%", y: "2%", width: "18%", height: "38%",
        topNum: "2vh", leftNum: "16vw" 
      },
      { 
        id: 4, 
        title: `מאגר הידע הלאומי`, 
        content: `הנגשת הספרייה הלאומית לחירום, שרשמה מעל 2,000 כניסות משתמשים, מעל 3,300 הורדות של קבצים מקצועיים, והשקת ערוץ YouTube ייעודי להפצת סרטוני ומנשרי למידה.`, 
        borderColor: "#585480",
        x: "1%", y: "5%", width: "19%", height: "35%",
        topNum: "7vh", leftNum: "-3vw" 
      }
