...
const QUESTIONS = [
  ...
  { q: ` מהו 'מעגל ההכשרה השלם'?`, choices: [` מעגל שאם מסתובבים בו, גשם מתחיל לרדת `, `  מעגל ההכשרות שעוברות על מנהלי המכלולים שמגיעים למכללה `,` המעגל שעובר דרך התורה, והיכולת ללמוד מהשטח ולהשתפר תו"כ תנועה `, `  כל מגמה בנפרד , כשכל אחד משפיע רק בתחומו `], a: 0 },
